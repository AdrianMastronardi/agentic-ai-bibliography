...
- **Yuntong Zhang et al. – *AutoCodeRover: Autonomous Program Improvement*
  ...
  [Read the full paper from this repo](../papers/zhang-autocoderover.pdf) ·
  [Read the full paper from the source](https://arxiv.org/abs/2404.05427) ·
  [Explore the code
  repository](https://github.com/AutoCodeRoverSG/auto-code-rover) · [Read the
  full paper from the source](https://arxiv.org/abs/2404.05427)
...
- **Shunyu Yao et al. – *WebShop: Towards Scalable Real-World Web Interaction
  ...
  eBay.  ·
  [Read the full paper from this repo](../papers/yao-webshop.pdf) · [Read the
...
- **Wentao Zhang et al. – *A Multimodal Foundation Agent for Financial
  ...
  [Read the full paper from this repo](../papers/zhang-finagent.pdf) · [Read
  the full paper from the source](https://arxiv.org/abs/2402.18485) · [Read
  the full paper from the source](https://arxiv.org/abs/2402.18485)
...
- **Fouad Bousetouane – *Agentic Systems: A Guide to Transforming Industries
  ...
  repo](../papers/bousetouane-agentic-systems.pdf) · [Read the full paper from
  the source](https://arxiv.org/abs/2501.00881) · [Explore the code
...
- **Chandan K. Reddy & Parshin Shojaee – *Towards Scientific Discovery with
  ...
  [Read the full paper from this
  repo](../papers/reddy-generative-ai-scientific-discovery.pdf) · [Read the
...
- **Chris Lu et al. – *The AI Scientist: Towards Fully Automated Open-Ended
  ...
  [Read the full paper from this repo](../papers/lu-ai-scientist.pdf) · [Read
  the full paper from the source](https://arxiv.org/abs/2408.06292) · [Read
  the full paper from the source](https://arxiv.org/abs/2408.06292)
...
- **Mourad Gridach et al. – *Agentic AI for Scientific Discovery: A Survey of
  ...
  [Read the full paper from this
  repo](../papers/gridach-agentic-ai-scientific-discovery.pdf) · [Read the
...
- **Samuel Schmidgall & Michael Moor – *AgentRxiv: Towards Collaborative
  ...
  collaboration.
  [Read the full paper from this repo](../papers/schmidgall-agentrxiv.pdf) ·
  [Read the full paper from the source](https://arxiv.org/abs/2503.18102) ·
  [Read the full paper from the source](https://arxiv.org/abs/2503.18102)
...
- **Tianshi Zheng et al. – *From Automation to Autonomy: A Survey on Large
  ...
  [Read the full paper from this
  repo](../papers/zheng-automation-to-autonomy.pdf) · [Read the full paper
  from the source](https://arxiv.org/abs/2505.13259) · [Read the full paper
  from the source](https://arxiv.org/abs/2505.13259)
...
- **Yutaro Yamada et al. – *The AI Scientist-v2: Workshop-Level Automated
  ...
  [Read the full paper from this repo](../papers/yamada-ai-scientist-v2.pdf) ·
  [Read the full paper from the source](https://arxiv.org/abs/2504.08066) ·
  [Read the full paper from the source](https://arxiv.org/abs/2504.08066)
